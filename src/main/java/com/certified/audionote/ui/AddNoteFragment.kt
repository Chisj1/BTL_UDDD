...
class AddNoteFragment : Fragment(), DatePickerDialog.OnDateSetListener,
    ...
    private val requestRecordAudioPermissionLauncher =
        registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
            ...
            else initializeSpeechRecognizer()
        }
...
//        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS)
    ...
    private fun stopRecording() {
        ...
        // Start speech-to-text after stopping the recording
        startSpeechToText()
    }
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(requireContext()).apply {
            setRecognitionListener(object : RecognitionListener {
                ...
                override fun onResults(results: Bundle?) {
                    ...
                    matches?.let {
                        val transcription = it.joinToString(" ")
                        _note.description = transcription
                        binding.etNoteDescription.setText(transcription)
    ...
    private fun startSpeechToText() {
        val intent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
            ...
            putExtra(RecognizerIntent.EXTRA_LANGUAGE, "vi-VI")
        }
